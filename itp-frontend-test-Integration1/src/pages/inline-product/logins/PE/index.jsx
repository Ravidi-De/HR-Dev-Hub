...
const PELogin = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) =>
      login(values, 'training-schedule-admin', '/inline-product-mgt/PE/Dashboard'),
  })

  return (
    <Login
      title="Production Engineer"
      subtitle="Use the relevant Login"
      illustrationUrl="/static/illustrations/Editorial commision-pana 1.svg"
    ...
    >
      <form className="flex flex-col" onSubmit={formik.handleSubmit}>
        ...
        <div className="flex justify-center">
          <Link to="/inline-product-mgt/IE/Login">
          ...
          <Link to="/inline-product-mgt/QE/Login">
            <Button className="text-md border-2 border-[#A4161A] text-[#A4161A] hover:bg-[#A4161A] hover:text-white rounded-lg px-8 py-1.5 my-4 block mx-4">
              Quality Executive
            </Button>
          </Link>

          <Link to="/inline-product-mgt/PE/Login">
            <Button className="text-md border-2 border-[#A4161A] text-[#A4161A] hover:bg-[#A4161A] hover:text-white rounded-lg px-8 py-1.5 my-4 block mx-4">
              Production Engineer
            </Button>
          </Link>
