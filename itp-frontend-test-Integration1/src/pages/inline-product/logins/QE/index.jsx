...
const QELogin = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) =>
      login(values, 'qe-engineer', '/inline-product-mgt/QE/Dashboard'),
  })
  ...
  return (
    <Login
      ...
      illustrationUrl="/static/illustrations/brand loyalty-amico.svg"
